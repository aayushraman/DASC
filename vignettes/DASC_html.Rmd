...
res <- convex_batch(edata = dat, pdata = pdat, factor = pdat$Cell, 
...
```{r, message=FALSE, eval=TRUE}
res <- convex_batch(edata = dat, pdata = metadata, 
                        factor = metadata$tissue, method = 'ama', type = 3, 
                        lambda = 1, rank = 2:3, nrun = 10, 
